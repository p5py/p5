...
src_default = ShaderSource(read_shader(
    '3d/default3d.vert'), read_shader('common/default.frag'))
...
src_normal = ShaderSource(read_shader('3d/normal.vert'),
                          read_shader('3d/normal.frag'))
src_phong = ShaderSource(read_shader('3d/phong.vert'),
                         read_shader('3d/phong.frag'))
