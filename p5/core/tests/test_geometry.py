...
class TestBoxGeometry(unittest.TestCase):
    def test_vertices(self):
        ...
        self.assertTrue(np.allclose(
            np.array(vertices), np.array(box.vertices)))
    ...
    def test_normals(self):
        ...
        self.assertTrue(np.allclose(np.array(normals),
                                    np.array(box.vertex_normals)))

    def test_triangle_edges(self):
        box.make_triangle_edges()
        edges = [
            [0, 1], [1, 2], [2, 0], [2, 1], [1, 3], [3, 2],
            [4, 5], [5, 6], [6, 4], [6, 5], [5, 7], [7, 6],
            [8, 9], [9, 10], [10, 8], [10, 9], [9, 11], [11, 10],
            [12, 13], [13, 14], [14, 12], [14, 13], [13, 15], [15, 14],
            [16, 17], [17, 18], [18, 16], [18, 17], [17, 19], [19, 18],
            [20, 21], [21, 22], [22, 20], [22, 21], [21, 23], [23, 22]
        ]
